 ...
 */
export default function Toolbox({ toolbarButtons }: IProps) {
     ...
     * @returns {void}
     */
    const onSetHangupVisible = useCallback(
        (visible: boolean) => {
     ...
     * @returns {void}
     */
    const onSetOverflowVisible = useCallback(
        (visible: boolean) => {
    ...
    return (
        <div className={cx(rootClassNames, shiftUp && "shift-up")} id="new-toolbox">
