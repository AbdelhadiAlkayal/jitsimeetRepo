...
const Prejoin = ({
    ...
    const onJoinButtonClick = async () => {
        ...
        const keyFromUrl = new URL(location.href).searchParams.get("key");
        const key: string = (keyFromUrl && keyFromUrl.replace(/\//g, "")) ?? String(localStorage.getItem("key"));
    ...
    return (
        ...
        >
            <div className={classes.inputContainer} data-testid="prejoin.screen">
                ...
                {errorMessages && <p style={{ color: "red", margin: 0 }}>{errorMessages}</p>}
                {showErrorOnField && (
